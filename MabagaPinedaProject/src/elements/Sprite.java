...
public abstract class Sprite {
	...
	private final static int COLLISION_ERRORW = 20;
	private final static int COLLISION_ERRORH = 5;
	//constructor
	...
	private Rectangle2D getBounds(){
		return new Rectangle2D(this.x, this.y, this.width-Sprite.COLLISION_ERRORW, this.height-Sprite.COLLISION_ERRORH);
	}
